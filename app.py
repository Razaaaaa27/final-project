# app.py
# Streamlit web app untuk prediksi inhibitor BACE-1.
# Mendukung 4 varian model: GIN/GINE x scaffold/stratified.
# Default: GINE-stratified (PR-AUC tertinggi).
...
<style>
  ...
  .stApp {{
      background:
        radial-gradient(circle at 12% 10%, var(--grid-rgba) 0%, transparent 28%),
        radial-gradient(circle at 88% 88%, var(--grid-rgba) 0%, transparent 35%),
  ...
  /* Target semua elemen teks di dalam radio label */
  .stRadio label *,
  .stRadio label span,
  .stRadio label p,
  .stRadio label div,
